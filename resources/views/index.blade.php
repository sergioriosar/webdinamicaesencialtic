...
<div class="red">
    ...
    <div id="linkeding">
        <a href="https://www.linkedin.com/" target="none" class="fab fa-linkedin"></a>
    </div>
</div>
@endsection
@section('navbar_top')
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="hero-text">
                        <h4><span></span></h4>
                        <h1 class="tipeo1">Servicios Informaticos</h1>
...
<footer class="footer">
    <div class="l-footer">
        ...
        <h2 style="color: white" class="footer_img">EsencialTIC</h2>
    <p>EsencialTIC - Tecnologias de la informacion y comunicacion
    </p>
    </div>
        <ul class="r-footer">
            <li>
